...
1. Make an [Issue](https://github.com/cannaan/SpriteAtlasExplorer/issues/new)
...
```json
    {
        "dependencies": {
            "com.cannaan.SpriteAtlasExplorer": "https://github.com/YOUR_USER/SpriteAtlasExplorer.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at qqconan2002@163.com.
